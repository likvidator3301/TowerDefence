...
class MinLevelLoader:
    def get_game_objects(self):
        ...
        scene_manager.add_behaviour(b.RecordsController())
        game_objects.append(scene_manager)
        ...
        game_objects.append(s.TowerLabel('TowerLabel_2', 550, 800,
                                         ...
                                         tower2))
        game_objects.append(s.UILabel('GoldLabel', 50, 750, 75, 50))
        ...
        records_button = s.VisibleGameObject('RecordsButton', 1550, 30, 80, 45, path_to_sprites + 'restart_button.png')
        records_button.add_behaviour(b.RecordsTableButton())
        game_objects.append(records_button)
...
class FirstSceneLoader(SceneLoader):
    def create_object(self):
        min_level = MinLevelLoader()
        path_to_sprites = os.path.join('Sprites', '')

        game_objects = min_level.get_game_objects()
...
class BaseSceneLoader(SceneLoader):
    def __init__(self):
        super().__init__()
        self.path_to_scene_sprite = ''
        self.game_objects = []
        self.game_objects.append(MinLevelLoader().get_game_objects())

    def create_object(self):
        return self.game_objects

    def get_path_to_scene_sprite(self):
        return self.path_to_scene_sprite

    def set_path_to_scene_sprite(self, path):
        self.path_to_scene_sprite = path

    def add_game_object(self, game_objects):
